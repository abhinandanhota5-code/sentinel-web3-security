class BlockchainProvider {
  ...
  /**
   * Fetches metadata for an address, such as labels, reputation, and warnings.
   * Returns null if no metadata is found or an error occurs.
   */
  async getAddressMetadata() {
    throw new Error('BlockchainProvider.getAddressMetadata() must be implemented');
  }
}
