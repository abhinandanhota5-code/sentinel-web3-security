        ...
        <div className="space-y-2.5">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {report.dataMode === 'REAL' ? (
              <span className="px-2.5 py-0.5 rounded-lg text-[10px] font-mono tracking-wider uppercase bg-emerald-500/15 border border-emerald-400/40 text-emerald-300 font-bold flex items-center gap-1.5 shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                <span>LIVE RPC / ETHERSCAN (REAL)</span>
              </span>
            ) : report.dataMode === 'DEMO' ? (
              <span className="px-2.5 py-0.5 rounded-lg text-[10px] font-mono tracking-wider uppercase bg-amber-500/15 border border-amber-400/40 text-amber-300 font-bold flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                <span>DEMO DATA (LOCAL FIXTURES)</span>
              </span>
            ) : report.dataMode === 'MIXED' ? (
              <span className="px-2.5 py-0.5 rounded-lg text-[10px] font-mono tracking-wider uppercase bg-sky-500/15 border border-sky-400/40 text-sky-300 font-bold flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-sky-400"></span>
                <span>MIXED PROVENANCE</span>
              </span>
            ) : report.dataMode === 'PRESET' ? (
              <span className="px-2.5 py-0.5 rounded-lg text-[10px] font-mono tracking-wider uppercase bg-purple-500/15 border border-purple-400/40 text-purple-300 font-bold flex items-center gap-1.5">
